...
- code_paths: 
- code_max_files: 600
- group_name: .tickets part 1
- group_slug: tickets-part-1
...
# 01) ROI=4.8 impact=6 confidence=0.80 effort=1 horizon=Immediate category=contracts/interfaces reference=tickets-part-1
...
if [ "${#code_args[@]}" -eq 0 ]; then
  echo "WARNING: no code files resolved for group '.tickets part 1'." >&2
fi
...
Strategist question #01  (codebase-driven, group: .tickets part 1)

Reference: tickets-part-1
...
# 02) ROI=4.6 impact=6 confidence=0.78 effort=1 horizon=Immediate category=contracts/interfaces reference=tickets-part-1
...
Strategist question #02  (codebase-driven, group: .tickets part 1)
...
# 03) ROI=5.1 impact=7 confidence=0.74 effort=1 horizon=NearTerm category=invariants reference=tickets-part-1
...
Strategist question #03  (codebase-driven, group: .tickets part 1)
...
# 04) ROI=4.7 impact=6 confidence=0.76 effort=1 horizon=NearTerm category=invariants reference=tickets-part-1
...
Strategist question #04  (codebase-driven, group: .tickets part 1)
...
# 05) ROI=4.4 impact=6 confidence=0.70 effort=1 horizon=NearTerm category=caching/state reference=tickets-part-1
...
Strategist question #05  (codebase-driven, group: .tickets part 1)
...
# 06) ROI=4.5 impact=6 confidence=0.75 effort=1 horizon=Immediate category=caching/state reference=tickets-part-1
...
Strategist question #06  (codebase-driven, group: .tickets part 1)
...
# 07) ROI=4.3 impact=6 confidence=0.68 effort=1 horizon=NearTerm category=background jobs reference=tickets-part-1
...
Strategist question #07  (codebase-driven, group: .tickets part 1)
...
# 08) ROI=4.2 impact=6 confidence=0.66 effort=1 horizon=NearTerm category=background jobs reference=tickets-part-1
...
Strategist question #08  (codebase-driven, group: .tickets part 1)
...
# 09) ROI=4.1 impact=6 confidence=0.64 effort=1 horizon=NearTerm category=observability reference=tickets-part-1
...
Strategist question #09  (codebase-driven, group: .tickets part 1)
...
# 10) ROI=4.0 impact=6 confidence=0.62 effort=1 horizon=NearTerm category=observability reference=tickets-part-1
...
Strategist question #10  (codebase-driven, group: .tickets part 1)
...
# 11) ROI=3.8 impact=6 confidence=0.60 effort=1 horizon=NearTerm category=permissions reference=tickets-part-1
...
Strategist question #11  (codebase-driven, group: .tickets part 1)
...
# 12) ROI=3.9 impact=6 confidence=0.62 effort=1 horizon=NearTerm category=permissions reference=tickets-part-1
...
Strategist question #12  (codebase-driven, group: .tickets part 1)
...
# 13) ROI=3.7 impact=6 confidence=0.58 effort=1 horizon=MidTerm category=migrations reference=tickets-part-1
...
Strategist question #13  (codebase-driven, group: .tickets part 1)
...
# 14) ROI=3.6 impact=6 confidence=0.56 effort=1 horizon=MidTerm category=migrations reference=tickets-part-1
...
Strategist question #14  (codebase-driven, group: .tickets part 1)
...
# 15) ROI=3.5 impact=6 confidence=0.54 effort=1 horizon=MidTerm category=UX flows reference=tickets-part-1
...
Strategist question #15  (codebase-driven, group: .tickets part 1)
...
# 16) ROI=3.4 impact=6 confidence=0.52 effort=1 horizon=MidTerm category=UX flows reference=tickets-part-1
...
Strategist question #16  (codebase-driven, group: .tickets part 1)
...
# 17) ROI=3.3 impact=6 confidence=0.50 effort=1 horizon=MidTerm category=failure modes reference=tickets-part-1
...
Strategist question #17  (codebase-driven, group: .tickets part 1)
...
# 18) ROI=3.2 impact=6 confidence=0.48 effort=1 horizon=LongTerm category=failure modes reference=tickets-part-1
...
Strategist question #18  (codebase-driven, group: .tickets part 1)
...
# 19) ROI=3.1 impact=6 confidence=0.46 effort=1 horizon=LongTerm category=feature flags reference=tickets-part-1
...
Strategist question #19  (codebase-driven, group: .tickets part 1)
...
# 20) ROI=3.0 impact=6 confidence=0.44 effort=1 horizon=LongTerm category=feature flags reference=tickets-part-1
...
Strategist question #20  (codebase-driven, group: .tickets part 1)
