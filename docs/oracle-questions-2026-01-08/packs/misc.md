...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/misc/10-observability-tracing.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/misc/11-permissions-authz-gaps.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/misc/12-permissions-secrets-config.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/misc/13-migrations-schema-migrations.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/misc/14-migrations-backfill-plan.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/misc/15-ux-flows-user-journeys.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/misc/16-ux-flows-edge-cases.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/misc/17-failure-modes-timeouts-retries.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/misc/18-failure-modes-rollback-plan.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/misc/19-feature-flags-flag-plan.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/misc/20-feature-flags-compat-rollout.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
