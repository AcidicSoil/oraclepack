...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/prd-tui/10-observability-tracing.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/prd-tui/11-permissions-authz-gaps.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/prd-tui/12-permissions-secrets-config.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/prd-tui/13-migrations-schema-migrations.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/prd-tui/14-migrations-backfill-plan.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/prd-tui/15-ux-flows-user-journeys.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/prd-tui/16-ux-flows-edge-cases.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/prd-tui/17-failure-modes-timeouts-retries.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/prd-tui/18-failure-modes-rollback-plan.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/prd-tui/19-feature-flags-flag-plan.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
...
# extra_files appended literally (may be empty; may include -f/--file):
oracle   --files-report   --write-output "docs/oracle-questions-2026-01-08/prd-tui/20-feature-flags-compat-rollout.md"   "${ticket_args[@]}"      -p "$(cat <<'PROMPT'
